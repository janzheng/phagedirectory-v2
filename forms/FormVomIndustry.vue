...
export default {
  ...
  data: function () {
    return {
      ...
      intro: this.$cytosis.find('Content.join-industry-form', {'Content': this.$store.state['Content']} )[0]['fields']['Markdown'],
      source: this.$cytosis.find('Content.join-industry-form', {'Content': this.$store.state['Content']} )[0]['fields']['JSON'],
      isPublished: this.$cytosis.find('Content.join-industry-form', {'Content': this.$store.state['Content']} )[0]['fields']['isPublished'],
      ...
      cta: this.$cytosis.find('Content.join-cta', {'Content': this.$store.state['Content']} )[0]['fields']['Markdown'],
