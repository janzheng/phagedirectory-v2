...
<template>
  ...
  <div class="AlertSignup" :class="classes">
    ...
    >
      <p v-if="description" >
        Alerts are sent when phages are needed to help treat someone’s infection.
      </p>
      <div>
        <label for="tlemail" class=" _v-middle _inline-block _margin-right-half"> 
          <span class="" >Subscribe to phage alerts:</span>
        ...
        <input type="text" name="email" id="tlemail" 
               class="_form-input --short --phage _inline _margin-right"
               placeholder="email@address.com" required/>
        <input type="hidden" value="1" name="embed"/>
        <input class="AlertSignup-cta _inline _button --phage --outline --short _margin-none-i" type="submit" value="Subscribe" />
      </div>
      <div class="AlertSignup-note _font-small _font-normal _padding-top-half">Alerts are only sent if we have urgent phage requests. <a href="/policies#alerts">Please review our policies.</a></div>
