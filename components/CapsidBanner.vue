      ...
      <form id="mc-embedded-subscribe-form"
        ...
        <div id="mc_embed_signup_scroll">
          ...
          <div class="mc-field-group">
            <input id="mce-EMAIL" :placeholder="placeholder" type="email" name="EMAIL" class="required email _form-input _radius --phage --short _margin-right-half" required>
            <input id="mc-embedded-subscribe" class=" _button _font-bold --outline _v-top _margin-bottom-none --short _margin-top-half" type="submit" value="Get Capsid &amp; Tail" name="subscribe" >
          </div>
        </div>
      </form>
    </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      banner: this.$cytosis.find('Content.capsid-banner', {'Content': this.$store.state['Content']} )[0]['fields']['Markdown'],
