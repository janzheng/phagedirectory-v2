...
<template>
  ...
  <div class="Capsid  ">
    ...
    <div v-for="issue of issues" v-if="(showPreview && issue.fields.isPreview) || issue.fields.isPublished"
      ...
      <div class="Capsid-body _grid-auto-1 _grid-gap-large">

        <div class="Capsid-main _section-article">
          ...
          <div v-if="getSponsors(issue).length>0" class="Capsid-sponsor" >
            <!-- Don't show Sponsor title, just keep the tag
              <h4 class="Capsid-sponsors-title">{{'Sponsors'}}</h4> -->
          ...
          <div class="Capsid-article _section-article">
            <div class="Capsid-article-main">
